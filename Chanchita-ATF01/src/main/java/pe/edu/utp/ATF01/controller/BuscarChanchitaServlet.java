...
public class BuscarChanchitaServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (res == null || res.depositos().isEmpty()) {
                // No se encontraron resultados, redirigir a la página de búsqueda
                resp.sendRedirect(req.getContextPath() + "/BuscarChanchita.jsp");
            } else {
                // Se encontraron resultados, continuar con la generación de la tabla y otros elementos
